      ...
      <div className="flex flex-col md:flex-row gap-8 w-full justify-between">
        ...
        <article className="flex gap-8 font-headline">
          <div className="flex flex-col items-start gap-y-2">
            ...
            <Link href='/' className="text-sm text-light/80">Buscar partidos</Link>
            <Link href='/categories' className="text-sm text-light/80">Clubes</Link>
          </div>
          <div className="flex flex-col items-start gap-y-2">
            <h3 className="text-lg font-semibold">Contacta con nosotros</h3>
            <Link href='/refunds' className="text-sm text-light/80">Política de Reembolsos</Link>
            <Atention/>
          </div>
        </article>
      </div>
