...
const Past = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const res = await fetch(`${API_BASE_URL}/rrpp/${user!.id}/events?history=true`, {
          method: "GET",
  ...
  return (
      <div className="w-full h-auto flex justify-center md:justify-start flex-wrap gap-8 py-10">
      {
        loading ?
          <div className="w-full h-auto flex flex-wrap  justify-center md:justify-start  gap-8 mb-28">
